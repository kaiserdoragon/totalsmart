...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function updateBannerVisibility() {
    ...
    const hideUntil = Number(localStorage.getItem("hideBannerUntil"));
    const now = Date.now();
  ...
  // PC / SP が切り替わった時
  pcMediaQuery.addEventListener("change", updateBannerVisibility);
