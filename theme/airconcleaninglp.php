    ...
    <section class="faq sec">
      <div class="contents">
        ...
        <dl>
          ...
          <dd>店舗、オフィス、工場、倉庫、クリニック、介護施設、商業施設、事務所など、法人・店舗・施設向けの業務用エアコン導入・交換に対応しています。</dd>
          <dt>現地調査や見積もりは必要ですか？</dt>
          <dd>業務用エアコンは、機器の馬力や台数だけでなく、配管、電源、搬入経路、室外機の設置場所、既存機器の撤去条件によって費用が変わります。<br>
            事前に型番・設置写真・室外機写真・台数を共有いただけるとスムーズです。</dd>
          <dt>業務用エアコンの交換時期を相談できますか？</dt>
          <dd>はい、相談可能です。設置から10年以上経過している場合や、修理を繰り返している場合は、交換を検討するタイミングです。<br>
            使用状況を確認したうえで、交換したほうがよいかをご案内します。</dd>
          <dt>修理と交換のどちらがよいか分かりません。</dt>
          <dd>使用年数、故障頻度、修理費用、部品供給の状況、電気代、現在の効き具合などを確認し、修理を続けるべきか、交換・買い替えを検討すべきかを整理します。<br>
            ぜひ一度ご相談ください。</dd>
          <dt>機種や馬力の選び方が分かりません。</dt>
          <dd>業務用エアコンは、部屋の広さだけで機種を決めると、能力不足や過剰設備につながる場合があります。<br>
            施設の用途、稼働時間、天井高、熱源、利用人数、設置環境を確認し、現場に合った機種・馬力・形状をご提案します。</dd>
          <dt>対応できる業務用エアコンの種類は何ですか？</dt>
          <dd>天井カセット形、天井吊形、床置形、壁掛形、ビルトイン形、ダクト形、パッケージエアコンなど、各種業務用エアコンの導入・交換をご相談いただけます。<br>
            現在の機器タイプが分からない場合もお問い合わせください。</dd>
          <dt>本体の販売から取付工事までまとめて依頼できますか？</dt>
          <dd>はい、機器選定、本体販売、取付工事、試運転までまとめてご相談いただけます。<br>
            既存機器の交換では、撤去やフロン回収も含めて、現場条件を確認しながらご提案します。</dd>
          <dt>営業中の店舗や稼働中の施設でも工事できますか？</dt>
          <dd>工事内容や現場状況によって異なります。営業や業務への影響を抑えられるよう、工事日程や作業時間を確認しながら調整します。<br>
            休日・営業時間外の工事をご希望の場合も事前にご相談ください。</dd>
          <dt>他メーカーからの入れ替えもできますか？</dt>
          <dd>はい、他メーカーの業務用エアコンからの入れ替えにも対応しています。<br>
            現在のメーカーや機種を確認し、設置環境や配管・電源の状況に合った交換機種をご提案します。</dd>
          <dt>支払い方法やリースは相談できますか？</dt>
          <dd>支払い方法やリースについては、案件内容や条件により確認が必要です。<br>
            導入台数、機器内容、工事範囲、希望時期を確認したうえで、対応可能な方法をご案内します。</dd>
          <dt>保証やアフター対応はありますか？</dt>
          <dd>メーカー保証や工事後の対応は、選定する機器や工事内容により異なります。<br>
            正式見積もり時に、保証範囲やアフター対応についてもご案内します。</dd>
        </dl>
      </div>
    </section>
