...
<main class="<?php echo esc_attr($slug_name . '_page'); ?>">
  <section class="company_about sec">
    <div class="container -md">
      ...
      <p>
        トータルスマート株式会社は愛知県・岐阜県・三重県・静岡県で<br class="is-hidden_sp">
        店舗・オフィス・工場・施設向けの防犯設備、通信設備、<br class="is-hidden_sp">
        省エネ設備、空調設備の導入・施工・保守を一括対応する会社です。<br class="is-hidden_sp">
        「複数業者に分けて依頼する手間を減らしたい」「設備コストを見直したい」<br class="is-hidden_sp">
        「導入後も相談できる会社に任せたい」という法人・店舗様を支援しています。
      </p>
      <section>
