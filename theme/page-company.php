...
<main class="<?php echo esc_attr($slug_name . '_page'); ?>">
  <section class="company_about sec">
    <div class="container -md">
      ...
      <p>
        トータルスマート株式会社は愛知県・岐阜・三重・静岡など東海エリアで、<br class="is-hidden_sp">
        防犯カメラ、LED照明、光回線、業務用エアコン、OA機器など<br class="is-hidden_sp">
        オフィス・店舗の設備工事を一括対応する総合設備会社です。<br>
        通信工事、防犯設備、省エネ機器の販売・施工・保守をワンストップで行い、<br class="is-hidden_sp">
        経費削減と業務効率化を実現します。<br>
      </p>
      <section>
        <h3 class="page_ttl">当社の強み</h3>
        <ul class="company_date--list">
          <li>自社施工部門による提案～工事～アフターサポートの一貫対応</li>
          <li>「一本の電話で全て解決」をモットーに、オフィス工事・店舗工事・設備に幅広く対応</li>
