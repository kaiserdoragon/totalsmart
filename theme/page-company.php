...
<main class="<?php echo esc_attr($slug_name . '_page'); ?>">
  <section class="company_about sec">
    <div class="container -md">
      ...
      <p>
        トータルスマート株式会社は愛知・岐阜・三重・静岡の<br class="is-hidden_sp">
        店舗・オフィス・工場・施設をサポートしています。<br>
        業務用エアコン、防犯カメラ、通信環境、LED、OA機器など、<br class="is-hidden_sp">
        幅広い設備・サービスのご提案から施工、導入後の保守まで一貫して対応しています。<br>
        お客様が設備ごとに複数の業者へ相談する負担を減らし、<br class="is-hidden_sp">
        長く安心して相談できるパートナーであることを目指しています。
      </p>
      <section>
        <h3 class="page_ttl">当社の強み</h3>
        <ul class="company_date--list">
          <li>提案から施工、導入後の保守まで自社施工部門が一貫対応。<br class="is-hidden_sp">営業担当・施工担当・サポート窓口が連携し、導入後のトラブルや追加工事にも迅速に対応します。</li>
          <li>防犯カメラ、通信回線、LED照明、業務用エアコン、OA機器などをまとめて相談可能。<br class="is-hidden_sp">複数業者への個別手配を減らし、設備導入の手間と管理コストを軽減します。</li>
          <li>長期的な安心と信頼をお届けするサポート体制</li>
        </ul>
      </section>
      <table>
        <tr>
        ...
        <tr>
          <th>所在地</th>
          <td>愛知県名古屋市東区代官町16-17<br>代官町ビルディング2F</td>
        </tr>
        <tr>
          <th>電話番号</th>
          <td>052-932-5450</td>
  ...
  <section class="company_message sec -bottom">
    <div class="container">
      ...
      <dl>
        ...
        <dd>
          社名の由来は、すべての経費を「トータル」に見直し、より「スマート」に削減するお手伝いをしたいという想いからです。
        </dd>
      </dl>

      <dl>
        <dt class="page_ttl">メッセージ</dt>
        <dd class="company_message--txt">
          現在のオフィスを取り巻く環境は、新しいシステムや技術がとても早いスピードで変化しており、<br class="is-hidden_sp">
          導入コストが上がっている状況になります。<br>
          その中でも特にコスト削減や業務の効率化は重要視されているのではないかと思います。<br>
          常にお客様目線で、その企業様にあった削減方法や業務の効率化を提案していきたいと思っております。<br>
          また導入後のアフターフォローが1番大事だと思っておりますので、自社工事やコールセンターを活用して、<br class="is-hidden_sp">
          お客様の問題点をいち早く解決していける体制を取っております。<br>
