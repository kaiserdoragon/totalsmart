  ...
  <section class="mitumori">
    <div class="container">
      ...
      <p class="mitumori--lead">
        業務用エアコンの電気代は、使用時間や稼働台数、電気料金単価によって大きく変わります。<br>
        毎月の負担を抑えるには、まず現在のコストと削減できる金額の目安を把握することが重要です。<br>
        以下のシミュレーションでは、簡単な項目を入力するだけで、<br class="is-hidden_sp">
        業務用エアコンの電気代と削減額の概算を確認できます。<br>
