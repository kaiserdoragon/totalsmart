    ...
    <div class="container">
      ...
      <div class="tab_change">
        <ul class="tab_change--list">
          ...
          <li class="tab_change--item" data-id="tab-3">Tab 3</li>
        </ul>
        <div class="tab_change--content -show" id="tab-1">
          <table>
            ...
            <tr>
              <th>仕事内容</th>
              <td>
                <p>オフィスや店舗などの「業務用エアコン」「LED照明」の設置・交換・修理や「通信工事」をお任せします。</p>
                <ul>
                ...
                <p>補助業務など、できることからお任せします！</p>
                <dl>
                  <dt>【入社後の流れ】</dt>
                  <dd>
                    ■1カ月～3カ月　OJT研修
                    補助作業からスタート！
                    先輩が横にいるので、わからないことはすぐに確認できます。
                    個々のペースに合わせて研修を行うので焦らず成長してください。
                  </dd>
                  <dd>
                    ■3カ月を目安に独り立ち（※経験者は1カ月が目安）
                    独り立ちまでの期間は目安なので、個々のペースで大丈夫です。
                    独り立ち後もしっかりサポートします！
                ...
                <dl>
                  <dt>【チーム／組織構成】</dt>
                  <dd>
                    「未経験で長く続くかな…」そんな不安をお持ちの方も多いと思います。当社では、未経験で入社された方の95%以上が3年以上継続して働いています。この数字が示すのは、単なる「人手不足だから採用する」のではなく、本当に働きやすい環境を整えているということです。
                    私たちは、入社していただく方を単なる「労働力」ではなく、会社の未来を一緒に築いていく大切なパートナーだと考えています。だからこそ、技術習得のためのサポートはもちろん、長く安心して働ける環境づくりに全力で取り組んでいます。未経験からのスタートでも、必ず一人前の技術者になれる。そして長く活躍できる。そんな確信を持って、あなたをお迎えします。
                    <br>
                    ★未経験入社の定着率95%以上！
                  </dd>
                </dl>
