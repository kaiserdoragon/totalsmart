        ...
        <div class="recruit_voice--txt">
          <dl>
            ...
            <dd>
              ...
              のことを知っていました。
              自由な社風と頑張ればその分稼げるということにとても魅力を感じ
              入社しました。
            </dd>
            <dt>Q.現在の業務内容をおしえてください。</dt>
            <dd>
              法人向けの通信回線の提案が主なものになります。
              飛び込み営業はなく、在宅アポインターさんが獲得して下さった
              アポイント先に訪問し営業をする流れになっています。
            </dd>
            <dt>Q.仕事をするうえで大切にしていることは何ですか？</dt>
            <dd>
              お客様から契約を頂いて終わりではないので、その後のサポートで
              もお客様に満足して頂けるよう心掛けています。
              その為には、メーカーや他部署との連携がとても大切であり、
              スムーズに事が運ぶようチームプレーを大事にしています。
            </dd>
            <dt>Q.ほぼ在宅での働き方についてどう感じていますか。</dt>
            <dd>
              今まで働いてきた会社では朝と夜は必ず事務所に行っていました。
              現在はとても楽になり、月2回事務所に行くだけになっています。
              そのため会社に帰ることを考えずに仕事のスケジュールを立てること
              もできますし、会社に寄らない分早く家に帰ることができ、その分
              プライベート時間に充てられるので、公私ともに充実した生活を
              送れていると思います。
            </dd>
            <dt>Q.これからの目標や展望をおしえてください。</dt>
            <dd>
              この会社は厳しいノルマなどはありませんが、頑張ったらその分給料
              に反映して頂けるので、やりがいがあると思います！
              会社に貢献するため、また自分のためにも今後も頑張りたいと
              思っています！！
            </dd>
          </dl>
        </div>
